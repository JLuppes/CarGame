...
```{.css .tall-code code-line-numbers="|0-4|6-7,13-14|17-19|21-28" code-fold="true" }
body{                                           /* <1> */
...
```{.js .med-code code-line-numbers="|22"}
function playGame() {
...
```{.js code-line-numbers="|7|14" .tall-code}
function movePowerup(car) {
    let ele = document.querySelectorAll(".powerup");
