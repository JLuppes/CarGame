...
`Update the existing body section of style.css`
```{.css .med-code code-line-numbers="|3" code-fold="true" }
body{
...
`Update the existing .roadArea in style.css`
```{.css code-line-numbers="true"}
.roadArea {                                     /* <2> */
